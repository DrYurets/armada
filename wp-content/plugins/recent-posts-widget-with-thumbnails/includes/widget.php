<?php if ($args['id']== 'sidebar-auto') { // cars
		...
		<div class="service-area">
					<div class="media">
						<div class="media-body">
							...
							<p><a href="<?php echo the_permalink(); ?>">
                                <?php
                                if ( $show_thumb ) :
			$is_thumb = false;
			// if only first image
        ...
        <ul>
			<?php while ( $r->have_posts() ) : $r->the_post(); ?>
				...
				?>><a href="<?php the_permalink(); ?>"<?php echo $link_target; ?>><?php
							...
							if ( ! $hide_title ) {
								?>
                                <span class="rpwwt-post-title"><?php if ( $post_title = $this->get_the_trimmed_post_title( $post_title_length ) ) {
									echo $post_title;
								} else {
									the_ID();
								} ?></span><?php
